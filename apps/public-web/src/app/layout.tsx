        ...
        <Providers>
          ...
          <header className="bg-equus-green text-white shadow-md sticky top-0 z-50 border-b border-equus-tan-light/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 text-xs font-bold text-white/50 bg-black/25 px-3 py-1.5 rounded-lg border border-white/5">
                <span className="h-2 w-2 rounded-full bg-emerald-500 animate-ping"></span>
                <span className="text-emerald-400">SYNC ACTIVO</span>
              </div>
            </div>
          </header>
          {children}
