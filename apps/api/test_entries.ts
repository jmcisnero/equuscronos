...
async function test() {
  ...
  console.log("Running service.findAllByCompetition with JUDGE tenant context...");
  tenantStorage.run({ tenantId: "a1000000-0000-0000-0000-000000000001" }, async () => {
    try {
      const result = await service.findAllByCompetition("c88eacaf-d206-418b-a2ff-224115490470");
