...
export class CreateOwnerDto {
  ...
  @IsString({ message: 'El nombre completo o razón social debe ser un texto válido.' })
  ...
  @IsOptional()
  @IsEnum(OwnerType, { message: 'La categoría seleccionada no es válida. Elija Persona Física, Stud o Haras.' })
  type?: OwnerType;
