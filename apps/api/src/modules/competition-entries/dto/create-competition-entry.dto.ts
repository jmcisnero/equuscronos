...
export class CreateCompetitionEntryDto {
  ...
  @ApiPropertyOptional({
    description: "UUID del Club que este binomio representa",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: "Dorsal o Chaleco numérico a utilizar en pista",
    example: 101,
  })
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    description: "Indica si este binomio califica para puntos",
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: "Peso de la montura / aperos en kg",
    example: 15.0,
  })
  @IsOptional()
  @IsNumber({ maxDecimalPlaces: 2 })
  ...
  @ApiPropertyOptional({
    description: "Elementos precintados",
    example: ["Jergón", "Mandil", "Montura"],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
