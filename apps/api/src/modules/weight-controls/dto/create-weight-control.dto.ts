...
export class CreateWeightControlDto {
  ...
  @ApiPropertyOptional({ description: 'UUID de la etapa (Nulo si es el pesaje inicial del sábado)' })
  @IsOptional()
  @IsUUID()
  stageId?: string;

  @ApiProperty({ description: 'Peso marcado por la balanza oficial', example: 85.5 })
